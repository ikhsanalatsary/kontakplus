  ...
  return function (scope, element, attrs) {
    ...
    function handleStyle(dim) {
      ...
      if ((dim.bottom - baseDimensions.top) > legacyToolbarH) {
        ...
        title.css('transform', 'scale(' + ((titleZoom - 1) * ratio(dim) + 1)
          + ',' + ((titleZoom - 1) * ratio(dim) + 1) + ')');
      ...
      element.css('background-color', 'rgba(' + primaryColor[0] + ',' + primaryColor[1]
        + ',' + primaryColor[2] + ',' + (1 - ratio(dim)) + ')');
